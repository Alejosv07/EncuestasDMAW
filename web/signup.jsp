			...
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/survey3.png" alt="IMG">
                            ...
                            <form action="CrearUsuarioControlador" class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Ingrese su Email: ej, ex@abc.xyz">
